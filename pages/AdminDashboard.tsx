...
interface AdminDashboardProps {
  ...
  onDeleteBaptism: (id: string) => void;
...
const AdminDashboard: React.FC<AdminDashboardProps> = ({
  cells = [], reports = [], shares = [], baptisms = [], goals = [], events = [], activeTab, onAddShare, onDeleteShare, onAddBaptism, onDeleteBaptism, onDeleteReport, onUpdateCell, onAddCell, onDeleteCell, onAddGoal, onUpdateGoal, onDeleteGoal, onNotify, onDismissLateAlert, onAddEvent, onDeleteEvent
}) => {
