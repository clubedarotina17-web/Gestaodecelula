...
import { User, Home, Users, MapPin, GraduationCap, PenTool, CheckCircle, ArrowLeft, Briefcase, Layers } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="p-5 bg-gray-50/80 rounded-3xl border border-gray-100 flex items-center gap-4 hover:bg-white hover:shadow-xl hover:shadow-gray-100 transition-all group">
              ...
              <div>
                ...
                <p className="font-bold text-primary text-sm md:text-base">{cell.host}</p>
              </div>
            </div>

            {/* Bloco: Líder em Treinamento */}
            <div className="p-5 bg-gray-50/80 rounded-3xl border border-gray-100 flex items-center gap-4 hover:bg-white hover:shadow-xl hover:shadow-gray-100 transition-all group">
              ...
              <div>
                <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest mb-0.5">Líder em treinamento</p>
                <p className="font-bold text-primary text-sm md:text-base">{cell.trainee}</p>
              </div>
            </div>
            ...
            <div className="p-5 bg-gray-50/80 rounded-3xl border border-gray-100 flex items-center gap-4 hover:bg-white hover:shadow-xl hover:shadow-gray-100 transition-all group">
              ...
              <div>
                ...
                <p className="font-bold text-primary text-sm md:text-base">{cell.secretary}</p>
              </div>
            </div>
